...
**String mode** runs through `bash -c` on Unix or the resolved bash on Windows. Use this when you need shell features like pipes, redirection, or variable expansion.
